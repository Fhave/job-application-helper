...
export default function CtaBannerSection() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="bg-sky-50 border border-sky-100 rounded-3xl p-5 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-10 sm:gap-12 relative overflow-hidden">
        {/* Left Column*/}
        <div className="space-y-5 sm:space-y-6 max-w-xl z-10 text-center lg:text-left">
          ...
          <p className="text-slate-600 text-base sm:text-lg font-medium font-sans max-w-md mx-auto lg:mx-0">
        ...
        {/* Right Column */}
        <div className="relative flex items-center justify-center z-10 w-full min-h-80 max-w-md lg:max-w-lg">
          <div className="relative w-56 sm:w-72 h-72 sm:h-80 rounded-3xl overflow-hidden shadow-sm bg-sky-200 shrink-0">
            <Image
              src={CtaImg}
          ...
          <div className="absolute top-2 right-[calc(50%-7rem)] sm:right-32 w-10 h-10 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center shadow-xs">
            <Smile className="w-6 h-6 stroke-2" />
          </div>

          <div className="absolute bottom-4 left-[calc(50%-7rem)] sm:left-10 text-sky-500 space-y-0.5">
            <Check className="w-5 h-5 stroke-3" />
            <Check className="w-5 h-5 stroke-3 -mt-3 ml-2" />
          </div>

          <div className="ml-4 sm:ml-10 space-y-4 flex flex-col items-center relative">
            <svg
